...
// Route::group(['middleware' => ['auth']], function(){
    ...
    //instansi
    Route::get('/data-instansi', [InstansiController::class, 'index'])->name('data-instansi');
    Route::get('/create-instansi', [InstansiController::class, 'create'])->name('create-instansi');
    Route::post('/simpan-instansi', [InstansiController::class, 'store'])->name('simpan-instansi');
